...
public class AuthManager : MonoBehaviour
{
    ...
    [Header("Register")]
    public TMP_InputField userRegField;
    public TMP_InputField emailRegField;
    public TMP_InputField passRegField;
    public TMP_InputField passRegVerField;
    ...
    {
        StartCoroutine(Register(userRegField.text, emailRegField.text, passRegField.text));
    }
    ...
    private IEnumerator Register(string _email, string _username, string _password)
    {
        ...
        else if (passRegField.text != passRegVerField.text)
        {
